package car_production_assignment;
...
public class Car_production_assignment {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Car_production_assignment window = new Car_production_assignment();
	 ...
	 */
	public Car_production_assignment() {
		initialize();
	}
	...
	private void initialize() {
		...
		lblNewLabel.setBounds(35, 19, 257, 60);
